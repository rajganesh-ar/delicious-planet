...
const EXPERIENCE_SLIDES: CarouselSlide[] = [
  {
    image: '/images/mega-menu/mega-menu-chef.avif',
  ...
  {
    image: '/images/mega-menu/mega-menu-dish.avif',
  ...
  {
    image: '/images/mega-menu/mega-menu-resturant.avif',
  ...
  return (
    <>
      ...
      <section className="relative h-[70vh] md:h-[80vh] lg:h-screen flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-black/10 md:bg-gradient-to-tr md:from-black/70 md:via-black/30 md:to-transparent" />

        {/* Content — bottom-left flush */}
        <div className="relative z-10 w-full px-5 md:px-6 lg:px-16 pb-8 md:pb-10 lg:pb-16">
          <div className="max-w-2xl text-left">
            <FadeIn>
              <p className="text-[10px] uppercase tracking-[0.3em] text-gold/80 font-medium m-0 mb-3 md:mb-4 flex items-center gap-3">
      ...
      <section className="bg-cream border-t border-gray-100 pt-8 md:pt-10 lg:pt-14">
        <div className="max-w-[1440px] mx-auto px-5 md:px-6 lg:px-16 mb-6 md:mb-8">
          <FadeIn>
            <p className="text-[10px] md:text-[11px] uppercase tracking-[0.3em] text-gold font-medium m-0 mb-2 flex items-center gap-3">
              <span className="inline-block w-6 md:w-8 h-px bg-gold/40" />
